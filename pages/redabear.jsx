...
import redabearr from '../public/assets/projects/redabear.png.png'
  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={redabearr} alt='/'/>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 p-t-8'>
        ...
        <a href='https://github.com/milekboy/First-real-website'>
